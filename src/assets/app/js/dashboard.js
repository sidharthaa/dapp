            ...
            var t = function () {
                if (0 != $("#m_chart_personal_income_quater_1").length) {
                    var e = new Chartist.Pie("#m_chart_personal_income_quater_1",
                        {
                            series: [{
                                value: JSON.parse(localStorage.getItem('data')).soldValueToken,
                                className: "custom",
                                meta: {
                            ...
                            {
                                value: JSON.parse(localStorage.getItem('data')).remainingValueToken,
                                className: "custom",
                                meta: {
                ...
                function () {
                    if (0 != $("#m_chart_profit_share").length) {
                        var e = new Chartist.Pie("#m_chart_profit_share", {
                            series: [{
                                value: JSON.parse(localStorage.getItem('data')).soldAccToken,
                                className: "custom",
                                meta: {
                                    color: mApp.getColor("brand")
                                }
                            }, {
                                value: JSON.parse(localStorage.getItem('data')).remainingAccToken,
                                className: "custom",
                                meta: {
                                    color: mApp.getColor("accent")
                                }
